...
The exact PPN match means that \textit{Solar System tests cannot distinguish DFD from GR}. This is by design: DFD's $\mu$-function reduces to $\mu \to 1$ in the high-acceleration Solar System regime, recovering Newtonian/GR dynamics.
