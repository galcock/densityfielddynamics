...
\label{eq:n-eff}
\end{equation}
where $\eta_c$ is the threshold (derived below), $\kappa = \ka = 3/(8\alpha) \approx 51.4$ is 
the coupling constant (Appendix~\ref{app:ka-derivation}), and $\Theta(x)$ is the Heaviside step function.
