...
\paragraph{Beyond $^{229}$Th: the $^{187}$Re nuclear sensitivity target.}
The Flambaum nuclear sensitivity formalism~\cite{Flambaum2006,AlcockNuclearDecay2026} predicts
$\kappa_q \propto n/Q$ for beta decays, placing ultra-low-$Q$ transitions
at the top of the hierarchy.  $^{187}$Re ($Q = 2.64$~keV, the lowest known
$\beta$-emitter $Q$-value) achieves $\kappa_q \approx 19{,}000$---roughly
$2\times$ the $^{229}$Th sensitivity.  A half-life measurement at fractional
precision $10^{-6}$, repeated at different orbital phases, would constrain
$k_q^{\rm eff} < 0.2$, directly probing the benchmark coupling scale.
This complements the $^{229}$Th nuclear clock: $^{187}$Re probes the
strong-sector coupling through a completely different experimental technique
(calorimetric or mass-spectrometric rather than optical frequency comparison),
providing independent confirmation or falsification.
A multi-isotope ratio test---simultaneously monitoring two isotopes with
different $\kappa_q$ in the same facility---would eliminate environmental
systematics by design and directly probe composition dependence.
